...
import '../domain/usecases/get_place_detail_usecase.dart' as _i25;
...
import '../presentation/blocs/get_places/get_places_bloc.dart' as _i26;
import '../presentation/blocs/get_roles/get_roles_bloc.dart' as _i27;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factoryAsync<_i16.SharedPreferences>(() => registerModule.prefs);
    ...
    gh.singleton<_i25.GetPlaceDetailUseCase>(
        _i25.GetPlaceDetailUseCase(repository: gh<_i17.GetPlacesRepository>()));
    gh.factory<_i26.GetPlacesBloc>(() => _i26.GetPlacesBloc(
          useCase: gh<_i19.GetPlacesUseCase>(),
          getPlaceDetailUseCase: gh<_i25.GetPlaceDetailUseCase>(),
        ));
    gh.factory<_i27.GetRolesBloc>(() => _i27.GetRolesBloc(
